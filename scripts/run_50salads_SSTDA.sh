...
path_model=./Models_SSTDA/ # user-defined (will create if not existing)
path_result=./Results_SSTDA/ # user-defined (will create if not existing)

# === Config & Setting === #
use_target=uSv # none | uSv
dataset=50salads # gtea | 50salads | breakfast
