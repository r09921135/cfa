...
# === Paths === #
path_data=/media/rayting/E080738880736446/RayTing_data/Datasets/action-segmentation/ # user-defined
path_model=./Models/ # user-defined (will create if not existing)
path_result=./Results/ # user-defined (will create if not existing)
...
do
    ...
    then
        ...
        --DA_adv $DA_adv --DA_adv_video $DA_adv_video --fore_attn $fore_attn --num_seg $num_seg --beta -2 -2 --iter_max_beta $iter_max_0 $iter_max_1 \
